...
def print_comparative_outcomes(multiCohortFairCoin, multiCohortUnFairCoin):
    ...
    increase = Stat.DifferenceStatIndp(
        ...
        x = multiCohortUnFairCoin.get_mean_total_reward(),
        y_ref = multiCohortFairCoin.get_mean_total_reward())
